...
module.exports = "<div ms-controller=\"aaa\">{{@params.a}}</div>"

/***/ }),
/* 4 */
/***/ (function(module, exports) {

module.exports = "<div ms-controller=\"bbb\">{{@params.a}}</div>"
...
var img = __webpack_require__(24);
...
function routeAdd(url, page) {
  var vmH = __webpack_require__(10)("./" + page + '/' + page + '.html');
  var vmC = __webpack_require__(11)("./" + page + '/' + page + '.js');
...
avalon.router.add("/aaa", function (a) {
  var vmH = __webpack_require__(3);
  var vmC = __webpack_require__(0);
  vm.page = vmH;
  vmC.params = this.params;
});
avalon.router.add("/bbb/:a/:b", function (a) {
  var vmH = __webpack_require__(4);
  var vmC = __webpack_require__(1);
  vm.page = vmH;
  vmC.params = this.params;
});
...
module.exports = "/assets/avatar-98e79410.jpg";
